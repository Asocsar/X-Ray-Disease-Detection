...
def main(metadata):
    ...
    train_loader, train_len, test_loader, test_len, val_loader, val_len = default_data_loader(metadata)

    model = Efficient_NoPretrain(metadata['NameEfficient'], N_CLASSES).cuda()
