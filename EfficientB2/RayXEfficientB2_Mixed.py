...
def main(metadata):
    ...
    for epoch in range(EPOCHS):
        ...
        train_Mixed(model, CLASS_NAMES, N_CLASSES, epoch, train_loader, train_len, optimizer, writer)
        model.eval()
        AUROC_avg, loss = val_Mixed(model, CLASS_NAMES, N_CLASSES, epoch, val_loader, val_len, optimizer, writer)
        model.train()
        scheduler.step(loss)
